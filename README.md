...
A token is used to validate user authentication, it gets stored in localstorage and is authenticated with the server when a user logs in.

- [ ] What steps can you take in your web apps to keep your data secure?

Add private routes that are only for the user with a token

- [ ] Describe how web servers work.

Web servers provide an interconnected network that pass data to each other. Our local servers have an API built in them and they provide data as well as functions that respond when we call any of our CRUD calls.
